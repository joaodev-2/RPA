    ...
    def resolver_via_audio(self):
        ...
        try:
            ...
            if btn_audio.is_visible():
                ...
                print(f"🗣️ [Captcha] Ouvido: {texto}")
            ...
            print("❌ [Captcha] Botão de áudio não disponível.")
            return False
